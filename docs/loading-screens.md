...
| --- | --- | --- |
| Delete all files | Clears the `addon/screenshots` folder | - |
| Open folder | Opens screenshots directory in explorer | - |
| Apply screenshots | Processes and applies images into `map_icons/screenshots` | - |
| Delete previous | Auto-deletes old screenshots when applying new ones | - |
